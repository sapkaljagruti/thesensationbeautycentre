...
if (isset($staff_member_detail)) {
    if (!empty($staff_member_detail)) {
        foreach ($staff_member_detail as $staff_member) {
            $id = $staff_member['id'];
            $staff_code = isset($_POST['staff_code']) ? $_POST['staff_code'] : $staff_member['staff_code'];
            $name = isset($_POST['name']) ? $_POST['name'] : $staff_member['name'];
            $designation = isset($_POST['designation']) ? $_POST['designation'] : $staff_member['designation'];
            $address = isset($_POST['address']) ? $_POST['address'] : $staff_member['address'];
            $permanent_address = isset($_POST['permanent_address']) ? $_POST['permanent_address'] : $staff_member['permanent_address'];
            ...
            $email = isset($_POST['email']) ? $_POST['email'] : $staff_member['email'];
            $mobile1 = isset($_POST['mobile1']) ? $_POST['mobile1'] : $staff_member['mobile1'];
            $mobile2 = isset($_POST['mobile2']) ? $_POST['mobile2'] : $staff_member['mobile2'];
            $residence_no = isset($_POST['residence_no']) ? $_POST['residence_no'] : $staff_member['residence_no'];
            $dob = isset($_POST['dob']) ? $_POST['dob'] : $staff_member['dob'];
            $doa = isset($_POST['doa']) ? $_POST['doa'] : $staff_member['doa'];
            $insurance_type = isset($_POST['insurance_type']) ? $_POST['insurance_type'] : $staff_member['insurance_type'];
            $insurance_name = isset($_POST['insurance_name']) ? $_POST['insurance_name'] : $staff_member['insurance_name'];
            $insurance_amount = isset($_POST['insurance_amount']) ? $_POST['insurance_amount'] : $staff_member['insurance_amount'];
            $insurance_from = isset($_POST['insurance_from']) ? $_POST['insurance_from'] : $staff_member['insurance_from'];
            $insurance_to = isset($_POST['insurance_to']) ? $_POST['insurance_to'] : $staff_member['insurance_to'];
            ?>
            <div class="row">
                <div class="col-md-12">
                    <!-- Horizontal Form -->
                        ...
                        <form class="form-horizontal" method="post">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="staff_code" name="staff_code" placeholder="Staff Code" value="<?php echo $staff_code; ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <textarea class="form-control" rows="3" placeholder="Permanent Address" id="permanent_address" name="permanent_address"><?php echo $permanent_address; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id="insurance_type" name="insurance_type" placeholder="Insurance Type" value="<?php echo $insurance_type; ?>">
                                    </div>
                                    <label for="insurance_name" class="col-sm-2 control-label">Insurance Name</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="insurance_name" name="insurance_name" placeholder="Insurance Name" value="<?php echo $insurance_name; ?>">
                                    </div>
                                    <label for="insurance_amount" class="col-sm-1 control-label">Amount</label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control decimal" id="insurance_amount" name="insurance_amount" placeholder="Insurance Amount" value="<?php echo $insurance_amount; ?>" onkeypress="return allowOnlyNumberWithDecimal(event)" oncopy="return false;" onpaste="return false;" autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group" id="insurance_validity_div">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group date">
                                            <input type="text" class="form-control" id="insurance_from" name="insurance_from" placeholder="Enter Insurance From Date" oncopy="return false;" onpaste="return false;" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask="" autocomplete="off" value="<?php echo $insurance_from; ?>" maxlength="20">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group date">
                                            <input type="text" class="form-control" id="insurance_to" name="insurance_to" placeholder="Enter Insurance To Date" oncopy="return false;" onpaste="return false;" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask="" autocomplete="off" value="<?php echo $insurance_to; ?>" maxlength="20">
