...
<!--                <button class="btn btn-app" id="delete_selected">
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table id="parties_table" class="table table-bordered table-hover" role="grid" aria-describedby="parties_table_info">
                        <thead>
                            <tr>
                                <th>Id</th>
                            ...
                            if ($parties->num_rows > 0) {
                                ...
                                <tbody>
                                    ...
                                    while ($party = $parties->fetch_assoc()) {
                                        ?>
                                        <tr id="tr_<?php echo $party['id']; ?>">
                                            <td><?php echo $party['id']; ?></td>
                                            <td><input type="checkbox" name="select_parties[]" data-id="<?php echo $party['id']; ?>"></td>
                                            <td><?php echo ucwords($party['name']); ?></td>
