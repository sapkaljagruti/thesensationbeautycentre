...
class PurchasebillController {
    ...
    public function __construct() {
        ...
        require_once 'models/PurchaseBill.php';
        $this->purchasebillobj = new PurchaseBill();
    ...
    public function add() {
        ...
        if (!empty($_POST)) {
            ...
            if (empty($errors)) {
                ...
                $staff_member = $this->staffobj->addstaff($staff_code, $name, $designation, $gender, $address, $permanent_address, $mobile1, $mobile2, $residence_no, $dob, $doa, $email, $insurance_name, $insurance_from, $insurance_to);
                if ($staff_member) {
